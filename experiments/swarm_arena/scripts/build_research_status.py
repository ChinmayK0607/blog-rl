...
- Estimated final cost: ${row["estimated_final_cost_usd"]:.2f}; last provider reading ${row["provider_last_spend_usd"]:.2f}. Final invoice verified: {row["final_invoice_verified"]}.
