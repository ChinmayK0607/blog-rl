...
RUN_ROOT=/home/ubuntu/semi/artifacts/qwen3-4b-instruct-medium-low-pass4-v1

"$ROOT/scripts/run_symbolic_model_benchmark.sh" \
  Qwen/Qwen3-4B-Instruct-2507 0,1,2,3,4,5,6,7 8033 2 4 30050 \
  "$ROOT/environments/symbolic_tool_calling_v1/eval_qwen3_instruct_medium_low_pass4.toml" \
  "$RUN_ROOT"
